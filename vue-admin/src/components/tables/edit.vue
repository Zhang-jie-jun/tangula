<template>
  <div class="tables-edit-outer">
    <div v-if="!isEditting" class="tables-edit-con">
      <span v-if="editable" @dblclick="startEdit" class="value-con">{{ value }}</span>
      <span v-else class="value-con">{{ value }}</span>
    ...
    <div v-else class="tables-editting-con">
      ...
      <Button @click="saveEdit" style="padding: 2px 2px;" type="text"><Icon type="md-checkmark"></Icon></Button>
      <Button @click="canceltEdit" style="padding: 2px 2px;" type="text"><Icon type="md-close"></Icon></Button>
    </div>
  </div>
</template>
