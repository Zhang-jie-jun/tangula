<template>
  <div>
    <Card title="公共主机列表" icon="ios-send" class="card-min-height">
      <!-- 主体部分 -->
      <div>
        <Row>
    ...
    <Modal
      ...
      <Form :rules="ruleValidate" ref="formCrtPlat" :model="formCrtPlat">
        ...
        <FormItem label="端口号" prop="port">
          <Input v-model="formCrtPlat.port" placeholder="请输入端口号"/>
        </FormItem>
        <FormItem label="用户名" prop="username">
          <Input v-model="formCrtPlat.username" placeholder="请输入用户名"/>
        </FormItem>
        <FormItem label="密码" prop="password">
          <Input v-model="formCrtPlat.password" placeholder="请输入密码"/>
        </FormItem>
      </Form>
      <div slot="footer">
        <Button type="primary" @click="crtPlat('formCrtPlat')">确定</Button>
      </div>
    </Modal>
    <el-dialog
