        ...
        <Menu mode="horizontal" :active-name="subItemIndex">
          ...
          <div style="min-height: 200px;">
            <div v-if="subItemIndex === 1">
              <platformPrivate v-if="isRouterAlive" :userAccess="this.access"/>
            </div>
...
import platformPublic from '@/components/platform/platformPublic.vue'
import platformPrivate from '@/components/platform/platformPrivate.vue'
...
export default {
  ...
  data () {
    return {
      ...
      menuList: [],
      subMenuList: [
        { id: 1, name: '私有平台', icon: 'md-cloud-done' },
        { id: 2, name: '公共平台', icon: 'md-cloud-done' }
      ],
      model1: ''
    }
  },
