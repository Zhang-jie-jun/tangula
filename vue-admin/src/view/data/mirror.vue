<template>
  <div class="layout">
    <Layout>
      <Content>
        <Menu mode="horizontal" theme="light" width="300px" :active-name="subItemIndex">
        ...
        <div style="min-height: 200px;">
          <div v-if="subItemIndex === 1">
            <mirrorPrivate v-if="isRouterAlive" />
          </div>
          <div v-if="subItemIndex === 2">
            <mirrorPublic v-if="isRouterAlive"/>
...
import mirrorPrivate from '@/components/mirror/mirrorPrivate.vue'
import mirrorPublic from '@/components/mirror/mirrorPublic.vue'
export default {
  name: 'mirror',
  components: {
    mirrorPrivate, mirrorPublic
  },
  data () {
    return {
      isRouterAlive: true,
      ...
      menuList: [],
      subMenuList: [
        { id: 1, name: '私有镜像', icon: 'ios-images' },
        { id: 2, name: '公共镜像', icon: 'ios-images' }
      ],
      model1: ''
    }
  },
